...
public class GameManager {
	...
	public void sendKilltop() {
		final ArrayList<UUID> temp = Options.getTopArray(PlayerManager.kills);
		final PlayerManager pm = SurvivalGames.getPlayerManager();
		Bukkit.broadcastMessage(Options.cc("&f&m--------------------------"));
		Bukkit.broadcastMessage(Options.cc("&61. " + pm.getNameByUUID(temp.get(0)) + " -> " + PlayerManager.kills.get(temp.get(0)) + " ¿ª±˛"));
		Bukkit.broadcastMessage(Options.cc("&e2. " + pm.getNameByUUID(temp.get(1)) + " -> " + PlayerManager.kills.get(temp.get(1)) + " ¿ª±˛"));
		Bukkit.broadcastMessage(Options.cc("&a3. " + pm.getNameByUUID(temp.get(2)) + " -> " + PlayerManager.kills.get(temp.get(2)) + " ¿ª±˛"));
		Bukkit.broadcastMessage(Options.cc("&f&m--------------------------"));
	}
