...
public class Arena {
	...
	public void saveCenter() {
		SurvivalGames.getFileManager().getClocation().set("Arenas." + name + ".center", Options.locToStr(center));
		SurvivalGames.getFileManager().saveLocationConfig();
	}

	public void saveTir2Chests() {
		SurvivalGames.getFileManager().getClocation().set("Arenas." + name + ".Tir2s", Options.locToStringList(tir2Chests).toArray());
		SurvivalGames.getFileManager().saveLocationConfig();
	}

	public void saveCenterChest() {
		SurvivalGames.getFileManager().getClocation().set("Arenas." + name + ".centerChest", Options.locToStringList(centerChests).toArray());
		SurvivalGames.getFileManager().saveLocationConfig();
	}
